                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text('Hôm nay - thứ 3 13 tháng 9,2022', style: TextStyle(fontSize: 14.0, color: Colors.black),),
                                            ),
                                            ListView.builder(
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(left: 10),
                                              child: Text('Hôm qua - thứ 2 12 tháng 9,2022', style: TextStyle(fontSize: 14.0, color: Colors.black),),
                                            ),
                                            ListView.builder(
                                                physics: NeverScrollableScrollPhysics(),
                                                itemCount: FAKE_BOX_LIST_JOB.length,
